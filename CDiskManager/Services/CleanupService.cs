...
public class CleanupService
{
    ...
    private static List<string> GetApplicationCachePaths()
    {
        ...
        return new List<string>
        {
            ...
            Path.Combine(appData, @"bilibili\Cache\Cache_Data"),
            ...
            Path.Combine(appData, @"bilibili\resource\.temp"),
            Path.Combine(appData, @"bilibili\logs"),
            Path.Combine(localAppData, "bilibili-updater"),
            Path.Combine(appData, @"QQ\Cache"),
            Path.Combine(appData, @"QQ\Cache\Cache_Data"),
            Path.Combine(appData, @"QQ\Code Cache"),
            Path.Combine(appData, @"QQ\GPUCache"),
            Path.Combine(appData, @"QQ\DawnGraphiteCache"),
            Path.Combine(appData, @"QQ\DawnWebGPUCache"),
            Path.Combine(appData, @"QQ\Network"),
            Path.Combine(appData, @"QQ\blob_storage"),
            Path.Combine(appData, @"QQ\Shared Dictionary\cache"),
            Path.Combine(appData, @"QQ\Partitions\*\Cache"),
            Path.Combine(appData, @"QQ\Partitions\*\Cache\Cache_Data"),
            Path.Combine(appData, @"QQ\Partitions\*\Code Cache"),
            Path.Combine(appData, @"QQ\Partitions\*\GPUCache"),
            Path.Combine(appData, @"QQ\Partitions\*\DawnGraphiteCache"),
            Path.Combine(appData, @"QQ\Partitions\*\DawnWebGPUCache"),
            Path.Combine(appData, @"QQ\Partitions\*\Network"),
            Path.Combine(appData, @"QQ\Partitions\*\blob_storage"),
            Path.Combine(appData, @"QQ\Partitions\*\Shared Dictionary\cache"),
            Path.Combine(appData, @"QQEX\Cache"),
            Path.Combine(appData, @"QQEX\Cache\Cache_Data"),
            ...
            Path.Combine(appData, @"QQEX\Shared Dictionary\cache"),
            Path.Combine(appData, @"QQEX\Partitions\*\Cache"),
            Path.Combine(appData, @"QQEX\Partitions\*\Cache\Cache_Data"),
            Path.Combine(appData, @"QQEX\Partitions\*\Code Cache"),
            Path.Combine(appData, @"QQEX\Partitions\*\GPUCache"),
            Path.Combine(appData, @"QQEX\Partitions\*\DawnGraphiteCache"),
            Path.Combine(appData, @"QQEX\Partitions\*\DawnWebGPUCache"),
            Path.Combine(appData, @"QQEX\Partitions\*\Network"),
            Path.Combine(appData, @"QQEX\Partitions\*\blob_storage"),
            Path.Combine(appData, @"QQEX\Partitions\*\Shared Dictionary\cache"),
            Path.Combine(appData, @"QQEX\users\*\Cache"),
            Path.Combine(appData, @"QQEX\users\*\Cache\Cache_Data"),
            Path.Combine(appData, @"QQEX\users\*\Code Cache"),
            Path.Combine(appData, @"QQEX\users\*\GPUCache"),
            Path.Combine(appData, @"QQEX\users\*\DawnGraphiteCache"),
            Path.Combine(appData, @"QQEX\users\*\DawnWebGPUCache"),
            Path.Combine(appData, @"QQEX\users\*\Network"),
            Path.Combine(appData, @"QQEX\users\*\blob_storage"),
            Path.Combine(appData, @"QQEX\users\*\Shared Dictionary\cache"),
            Path.Combine(appData, @"Tencent\OMGCACHE"),
            Path.Combine(appData, @"Tencent\QQTempSys"),
            Path.Combine(appData, @"Tencent\QQ\STemp"),
            Path.Combine(appData, @"Tencent\QQNT\Cache"),
            Path.Combine(appData, @"Tencent\QQNT\STemp"),
            Path.Combine(appData, @"Tencent\QQMusic\Cache"),
            Path.Combine(appData, @"Tencent\QQMusic\gs_webview_data\EBWebView\GraphiteDawnCache"),
            Path.Combine(appData, @"Tencent\QQMusic\gs_webview_data\EBWebView\GrShaderCache"),
            Path.Combine(appData, @"Tencent\QQMusic\gs_webview_data\EBWebView\ShaderCache"),
            Path.Combine(appData, @"Tencent\QQMusic\wmpf\data\cache"),
            Path.Combine(appData, @"Tencent\QQLive\Cache"),
            Path.Combine(appData, @"Tencent\QQLive\CacheFile"),
            Path.Combine(appData, @"Tencent\QQLive\danmu_cache_dir"),
            Path.Combine(appData, @"Tencent\QQLive\ImageCache"),
            Path.Combine(appData, @"Tencent\QQLive\webkit_cache"),
            Path.Combine(appData, @"Tencent\QQLive\Webkit3\Cache"),
            Path.Combine(appData, @"Tencent\QQLive\Webkit3\Cache_pac"),
            Path.Combine(appData, @"Tencent\QQLive\Webkit3\Cache_proxy"),
            Path.Combine(appData, @"Tencent\WeMeet\Cache"),
            Path.Combine(appData, @"Tencent\WeMeet\Global\Data\WebkitCacheData"),
            Path.Combine(appData, @"Tencent\Wedoc\cache"),
            Path.Combine(appData, @"Tencent\WeMail\cache"),
